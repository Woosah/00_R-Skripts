...
# fitOR <- glm(y ~ swiss$Examination + swiss$Education + swiss$Catholic + swiss$Infant.Mortality, family=binomial(link="logit"))
# sjp.glm(fitOR, transformTicks=TRUE)
# sjp.glm(fitOR, type="bars", errorBarWidth=0)
